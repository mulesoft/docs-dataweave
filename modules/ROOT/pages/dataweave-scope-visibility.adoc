...
You don't write the descriptor manually. The xref:dataweave-maven-plugin.adoc[Maven plugin for DataWeave] generates it automatically:
...
* xref:dw-component.adoc[`dw::meta::Component` Module]
* xref:dw-core-annotations.adoc[`@VisibleTo` Annotation]
* xref:dataweave-maven-plugin.adoc[Maven plugin for DataWeave]
* xref:dataweave-extension-plugin.adoc[DataWeave extension plugin]
