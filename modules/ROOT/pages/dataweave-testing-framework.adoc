...
You can create tests for your DataWeave mappings and modules either by using the Visual Studio Code (VS Code) plugin, see xref:dataweave-extension-plugin.adoc[Installing and Using the DataWeave Extension] for instructions, or manually by modifying your project's `pom.xml` file.
