...
:page-aliases: 3.9@mule-runtime::dataweave-reference-documentation.adoc
...
DataWeave supports streaming a large payload. No configuration is necessary in the DataWeave code itself, but other components need to be set up for this to work. See xref:1.0@dataweave-streaming.adoc[DataWeave Streaming].
...
xref:3.9@mule-runtime::mule-expression-language-mel.adoc[Mule Expression Language (MEL)] expression.
...
You can take any *Outbound Properties* in the Mule message that arrives to the DataWeave transformer and use it in your transform body. To refer to it, simply call it through the matching xref:3.9@mule-runtime::mule-expression-language-mel.adoc[Mule Expression Language (MEL)] expression.
...
Your DataWeave code can call any function you define as a global xref:3.9@mule-runtime::mule-expression-language-mel.adoc[Mule Expression Language (MEL)] function, as long as it is correctly defined in the Mule Project where your Transform Message element sits.
...
* xref:1.0@dataweave-tutorial.adoc[DataWeave Tutorial]
