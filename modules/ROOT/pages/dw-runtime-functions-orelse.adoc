...
:page-aliases: 4.3@mule-runtime::dw-runtime-functions-orelse.adoc
...
This example demonstrates how to specify the next expression to evaluate after a try() has failed
