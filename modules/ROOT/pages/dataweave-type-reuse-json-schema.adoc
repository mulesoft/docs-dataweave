...
=== Limitations 
* Formats on JSON schema string types are not supported and they will be transformed to String without any validation or restriction.
* Restrictions on number types such as maximums or minimums are not supported and they will be transformed to Number without any validation or restriction.
* Patterns are not supported.

=== Object types
* Non required properties in JSON Schema object types will be marked as optional properties in the DataWeave Object type
====
.For example:
[source,JSON]
----
...
.Will produce the following DataWeave Type:
...
----
====
* Allowing additional properties will produce a DataWeave open Object definition.
====
.For example:
...
----
====
* On the contrary if additional properties are not allowed DataWeave will produce a closed Object definition.
====
.For example:
...
Using this keywords in JSON schema will produce complex types using the subschemas provided:
