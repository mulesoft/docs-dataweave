...
:page-aliases: 4.1@mule-runtime::dw-arrays-functions-every.adoc
...
This example applies a variety of expressions to the input arrays and returns `true`
if the expression is true for every item in the input array. The `$`
