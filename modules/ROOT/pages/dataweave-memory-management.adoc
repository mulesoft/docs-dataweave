...
image::dataweave-memory-management-541a1.png["A flow diagram showing steps from reading CSV to writing JSON."]
...
image::dataweave-memory-management-dc180.png["A flow diagram for handling JSON output in a data processing sequence."]
