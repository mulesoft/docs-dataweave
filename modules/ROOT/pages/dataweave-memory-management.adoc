...
This system property determines the size in bytes of the internal byte array buffers used in DataWeave to process inputs and outputs. The default buffer size is 8192 bytes (8 KB).
