...
Those buffer files remain in the temporary directory until the streams referencing them are closed (some DataWeave files created when executing a flow could remain there until the flow ends).
