...
MuleSoft uses the standard Base64 encoding as defined in https://www.rfc-editor.org/rfc/rfc4648#section-4[RFC 4648, section 4]. This standard includes the `+` and `/` characters and uses `=` for padding. The encoding isn't URL safe. To use Base64 encoding in a URL, you must first encode the URL separately.
