...
| DesignOnlyType
| `@DesignOnlyType&#40;&#41;`
| Annotation that marks a parameter type as "Design Only" to indicate that
...
| TailRec
| `@TailRec&#40;&#41;`
| Annotation that marks a function as tail recursive. A function with
this annotation that is not tail recursive will fail.
