...
:page-aliases: 3.7@mule-runtime::dataweave-streaming.adoc
...
In order for DataWeave to process the file stream, the input must enter DataWeave as a stream. For example, flows that start with a xref:3.7@mule-runtime::file-transport-reference.adoc[file transport inbound endpoint] must have streaming enabled.
