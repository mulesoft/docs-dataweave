...
:page-aliases: 4.3@mule-runtime::dw-core-functions-distinctby.adoc
...
act on an object and handle a null value. DataWeave uses the result of applying the provided lambda as the uniqueness criteria.
