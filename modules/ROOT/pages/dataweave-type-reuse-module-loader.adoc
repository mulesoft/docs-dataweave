...
As previously mentioned, this is a translation between the XML schema type system to our own. 
Therefore, as the two type models are considered different, some general rules and limitations apply.
