...
This example contains only 1 part in the multipart which is the file. In case you want to add more parts, add them under the `parts:{}` section with the following format:
