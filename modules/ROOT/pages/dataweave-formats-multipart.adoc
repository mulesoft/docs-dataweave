...
* `orderAck`: Contains a text with an acknowledgement of the receipt of an order. The Content-Type is `text/plain`.  The ^mimeType` selector becomes useful to be able to log the Content-Type as part of the message.
