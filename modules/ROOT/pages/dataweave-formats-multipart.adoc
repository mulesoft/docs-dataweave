...
This example contains two parts in the multipart which is the file and the 'otherJsonPart'. In case you want to add more parts, add them under the `parts:{}` section with the following format:
