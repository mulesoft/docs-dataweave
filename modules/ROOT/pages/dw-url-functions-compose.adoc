...
:page-aliases: 4.2@mule-runtime::dw-url-functions-compose.adoc
...
|===
| Name | Description
| `baseStringArray` | A string array that contains the URL parts to interpolate using the strings in the `interpolationStringArray` parameter.
