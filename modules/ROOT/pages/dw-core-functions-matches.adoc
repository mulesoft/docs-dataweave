...
:page-aliases: 4.2@mule-runtime::dw-core-functions-matches.adoc
...
value, see
https://docs.mulesoft.com/mule-runtime/4.2/dataweave-pattern-matching[Pattern Matching in DataWeave].
