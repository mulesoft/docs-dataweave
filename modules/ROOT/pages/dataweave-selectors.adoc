...
:page-aliases: 4.2@mule-runtime::dataweave-selectors.adoc
...
You can select xref:4.2@mule-runtime::about-mule-event.adoc[Mule event] data by using
...
xref:4.2@mule-runtime::mule-runtime::about-mule-message#_message_payload[Message Payload].
...
For more on Mule variables, see xref:4.2@mule-runtime::mule-runtime::about-mule-variables.adoc[Variables in Mule Apps].
...
For more on flows, see xref:4.2@mule-runtime::about-flows.adoc[Flows and Subflows].
|===
