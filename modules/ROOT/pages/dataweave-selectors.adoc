...
// :page-aliases: 4.1@mule-runtime::dataweave-selectors.adoc
...
You can select xref:4.1@mule-runtime::about-mule-event.adoc[Mule event] data by using
...
xref:4.1@mule-runtime::about-mule-message#_message_payload[Message Payload].

| *Attribute*
a| `attributes.<myAttributeName>`

For examples, see xref:4.1@mule-runtime::about-mule-message#_attributes[Attributes].
...
For more on Mule variables, see xref:4.1@mule-runtime::about-mule-variables.adoc[Variables in Mule Apps].
...
For more on flows, see xref:4.1@mule-runtime::about-flows.adoc[Flows and Subflows].
|===
