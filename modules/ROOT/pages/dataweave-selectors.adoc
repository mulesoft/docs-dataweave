...
| Index | `[<index>]` | Value of any type at selected array index. Use negative numbers to index from the end of an array, starting with `-1` for the last element in the array.
