...
:page-aliases: 3.8@mule-runtime::dataweave-language-introduction.adoc
...
[NOTE]
The `lookup` function does not support calling xref:3.8@mule-runtime::flows-and-subflows.adoc#types-of-flows[subflows].

== Calling Global MEL Functions from DataWeave Code

If you define a global xref:3.8@mule-runtime::mule-expression-language-mel.adoc[Mule Expression Language] (MEL) function in your Mule project, you can then invoke it anywhere in your DataWeave code, without need for any special syntax.
