...
:page-aliases: 3.7@mule-runtime::dataweave-tutorial.adoc
...
. Drag a xref:xref:3.7@mule-runtime::web-service-consumer.adoc[Web Service Consumer] to your flow. Create a global configuration for it by clicking the green plus sign in its properties editor. In the *WSDL Location* field, paste the following URL: **http://tshirt-service.cloudhub.io/?wsdl**.  Note that all of the other fields in the configuration element are completed automatically when you do this. Then click *Ok*.
