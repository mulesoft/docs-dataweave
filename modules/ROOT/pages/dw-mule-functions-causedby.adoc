...
:page-aliases: 4.3@mule-runtime::dw-mule-functions-causedby.adoc
...
with a Mule message object. See https://docs.mulesoft.com/mule-runtime/latest/dataweave-variables-context[DataWeave Variables for Mule Runtime] for more details.
