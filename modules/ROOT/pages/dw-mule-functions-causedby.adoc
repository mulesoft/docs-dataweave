...
:page-aliases: 4.2@mule-runtime::dw-mule-functions-causedby.adoc
...
https://docs.mulesoft.com/mule-runtime/4.2/dataweave-variables-context[DataWeave Variables for Mule Runtime]).
