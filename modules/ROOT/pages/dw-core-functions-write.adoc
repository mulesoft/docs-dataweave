...
:page-aliases: 4.2@mule-runtime::dw-core-functions-write.adoc
...
| `writerProperties` | Optional: Sets writer configuration properties. For writer configuration properties (and other supported MIME types), see https://docs.mulesoft.com/mule-runtime/4.2/dataweave-formats[DataWeave Output Formats and Writer Properties].
|===
