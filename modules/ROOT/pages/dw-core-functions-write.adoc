...
:page-aliases: 4.1@mule-runtime::dw-core-functions-write.adoc
...
| `writerProperties` | Optional: Sets writer configuration properties for the particular content type. For writer configuration properties (and other content types), see https://docs.mulesoft.com/mule-runtime/4.1/dataweave-formats[DataWeave Output Formats and Writer Properties].
|===
