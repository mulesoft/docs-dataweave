...
====  The multipart/form-data reader doesn't support UTF-8 characters by default

If non-ascii characters are used in the multipart filenames, it will result in corrupted data. 
