...
:page-aliases: 4.3@mule-runtime::dataweave-language-guide.adoc
...
* xref:4.3@mule-runtime::about-mule-message.adoc[Mule Message Structure]
* xref:4.3@mule-runtime::about-mule-event.adoc[Mule Events]
* xref:4.3@mule-runtime::about-components.adoc[Core Components]
* xref:connectors::index.adoc[Connectors and Modules]
* xref:4.3@mule-runtime::transform-component-about.adoc[Transform Message Component]
