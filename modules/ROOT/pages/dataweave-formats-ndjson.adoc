...
These parser strategies are supported by the ndjson reader:
...
|`skipInvalid`  |`Boolean`|`false`|Skips invalid records and ignores values that aren't valid in this format.
