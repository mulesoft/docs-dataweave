...
You can also call upon the power of DataWeave language within _other_ components by using xref:3.9@mule-runtime::xref:3.9@mule-runtime::mel-dataweave-functions.adoc[Mule Expression Language DataWeave Functions].
