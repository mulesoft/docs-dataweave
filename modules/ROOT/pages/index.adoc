...
You can also call upon the power of DataWeave language within _other_ components by using xref:3.8@mule-runtime::mel-dataweave-functions.adoc[Mule Expression Language DataWeave Functions].
