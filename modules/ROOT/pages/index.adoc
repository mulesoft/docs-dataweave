...
* graphically map fields by dragging one attribute to another, just like you were able to with the now deprecated xref:6.x@studio::datamapper-user-guide-and-reference.adoc[DataMapper], or
...
You can also call upon the power of DataWeave language within _other_ components by using xref:3.9@mule-runtime::mel-dataweave-functions.adoc[Mule Expression Language DataWeave Functions].
...
* Read all about how to leverage the Anypoint Studio UI on xref:6.x@studio::transform-message-component-concept-studio.adoc[About Transform Message Component]
...
[TIP]
====
DataWeave replaces xref:6.x@studio::datamapper-user-guide-and-reference.adoc[DataMapper]. MuleSoft recommends you use DataWeave, if possible, to avoid future obsolescence.
