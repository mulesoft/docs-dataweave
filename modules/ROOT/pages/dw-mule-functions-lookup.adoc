...
Note that the `lookup` function _doesn't_ support calling subflows.
...
_This function is *Deprecated*. Use https://docs.mulesoft.com/dataweave/latest/dataweave-functions[], instead._
