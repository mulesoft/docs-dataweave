...
:page-aliases: 4.1@mule-runtime::dw-strings.adoc
...
DataWeave script. Note that the xref:dw-core.adoc[Core] DataWeave function
module also contains some functions that handle strings.
