...
This optional `=== Parameters` section describes parameters of the function.
...
....
 ...
 |===
 | Name | Description
 | `yourParameter1` | Your description here.
 | `yourParameter2` | Your description here.
 |===
....
...
* `==== Input` for output generated by the script.
