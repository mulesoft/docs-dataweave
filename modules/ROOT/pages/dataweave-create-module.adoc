...
image::dataweave-mapping-file.png["A DataWeave script with a function to capitalize keys and map payload values"]
...
image::dataweave-function-custom.png["A DataWeave script with a custom function module"]
 ...
 * https://docs.mulesoft.com/dataweave/latest/dataweave-operators[DataWeave Operators].
 */
%dw 2.0
----
