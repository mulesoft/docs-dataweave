...
* An embedded xref:dataweave-maven-plugin.adoc[DataWeave Maven plugin]:
...
** Automatic generation of a documentation template you can use to provide for DataWeave library documentation in Exchange.
