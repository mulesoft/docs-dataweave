...
:page-aliases: 4.1@mule-runtime::dataweave-cookbook-extract-data.adoc
...
object. Before you begin, note that DataWeave version 2 (`%dw 2.0` in script headers) is for Mule 4 apps.
For a Mule 3 app, refer to DataWeave version 1 (xref:3.9@mule-runtime::dataweave-examples.adoc[%dw 1.0])
