...
== DataWeave Troubleshooting Logs

If an error occurs while you are creating, running, or testing your modules and mappings or any other unexpected error happens with Visual Studio Code and the DataWeave Extension, check the log output of the DataWeave Language Server that provide details of what can cause the issue:
