= Installing and Using the DataWeave Extension Plugin
...
The tests use functions of the modules `dw::test::Tests` and `dw::test::Asserts` provided by the artifact `org.mule.weave.wtf` of the xref:dataweave-testingframework.adoc[DataWeave Testing Framework].
