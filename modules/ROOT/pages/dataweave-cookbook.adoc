...
The following DataWeave examples demonstrate common data extraction and transformation approaches. There are general examples of how to transform data, and also examples of how to use DataWeave in Mule runtime engine (Mule) applications.
//LINK TO DW 1.0 EXAMPLES:
include::partial$dataweave1-links.adoc[tag=dataweave1Examples]

== DataWeave General Examples

These examples show how to use DataWeave to extract and transform data.
...
== DataWeave Examples in Mule

These examples show how to use DataWeave to extract and transform data in Mule applications.
...
//read-connector
| xref:dataweave-cookbook-writer-prop-mule.adoc[Use a Mule Variable as a Configuration Value]
