...
| xref:dw-math-functions-decimalpow.adoc[decimalPow] | Returns a number with value base^exponent with rounding specified by the operation context. Maximum value for exponent
is 99999999.
