...
:page-aliases: 4.3@mule-runtime::dw-operators.adoc

DataWeave version 2 supports several operators, including mathematical operators, equality operators, and operators such as prepend, append and update.
...
DataWeave version 2 supports operators for appending and prepending items within
an array:
