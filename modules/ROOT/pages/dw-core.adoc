...
| xref:dw-core-functions-evaluatecompatibilityflag.adoc[evaluateCompatibilityFlag] | Returns the value of the compatibility flag with the specified name.
...
| xref:dw-core-functions-logdebug.adoc[logDebug] | Helper function that logs messages at `Debug` level.
| xref:dw-core-functions-logerror.adoc[logError] | Helper function that logs messages at `Error` level.
| xref:dw-core-functions-loginfo.adoc[logInfo] | Helper function that logs messages at `Info` level.
| xref:dw-core-functions-logwarn.adoc[logWarn] | Helper function that logs messages at `Warn` level.
| xref:dw-core-functions-logwith.adoc[logWith] | Without changing the value of the input, `logWith` returns the input as a system log at the specified level.
...
| xref:dw-core-functions-typeof.adoc[typeOf] | Returns the primitive data type of a value, such as `String`.
