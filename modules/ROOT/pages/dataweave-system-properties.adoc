...
* Default:
  ...
  ** `false` for language levels: 2.10
...
The default value evaluates the current JDK version used and the language level. The value is `true` when the used JDK is 17 or later and the language version is 2.10 or later.
If set to `false`, the JavaModuleLoader uses the specific bean's class definition to access properties via reflection, which can cause accessibility issues.
...
Available for language levels: 2.5, 2.6, 2.7, 2.8, 2.9, 2.10
...
* Default:
  ...
  ** `true` for language levels: 2.9, 2.10

Available for language levels: 2.8, 2.9, 2.10
...
* Default:
  ** `true` for language levels: 2.0, 2.1, 2.2, 2.3, 2.4, 2.5, 2.6, 2.7, 2.8, 2.9, 2.10

Available for language levels: 2.0, 2.1, 2.2, 2.3, 2.4, 2.5, 2.6, 2.7, 2.8, 2.9, 2.10
...
Available for language levels: 2.9, 2.10
...
* Default:
  ...
  ** `true` for language levels: 2.6, 2.7, 2.8, 2.9, 2.10

Available for language levels: 2.4, 2.5, 2.6, 2.7, 2.8, 2.9, 2.10
