...
DataWeave supports several system properties. To use these properties in application development and deployments, see xref:mule-runtime::mule-app-properties-system.adoc[].
...
* Default:
  ** `false` for language levels: 2.5, 2.6
...
* Default: `true` for language levels: 2.5, 2.6
