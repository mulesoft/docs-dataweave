...
|`com.mulesoft.dw.buffered_char_sequence.enabled`|
Controls whether an internal BufferedCharSequence improvement is enabled or disabled. When this property is set to `true`, DataWeaves avoid load large fields (bigger than 1.5M) into memory. This fields are read by chunk. This feature introduces a performance reduction preventing an Out of Memory error.
* Type: `Boolean`
* Default: `true`
...
|`com.mulesoft.dw.java.stacktrace`|
Specifies the depth of the java stacktrace
* Type: `Integer`
* Default: `6`
