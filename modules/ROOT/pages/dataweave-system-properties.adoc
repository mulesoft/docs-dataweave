...
When set to true, DataWeave disables the `default` operator to catch runtime exceptions.
Enabling this behavior `default` operator doesn't return the `default value` when a runtime exception occurs.
