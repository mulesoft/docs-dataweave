...
** xref:dw-binaries-functions-frombase64.adoc[]
** xref:dw-binaries-functions-fromhex.adoc[]
...
** xref:dw-coercions-functions-toarray.adoc[]
** xref:dw-coercions-functions-tobinary.adoc[]
** xref:dw-coercions-functions-todate.adoc[]
