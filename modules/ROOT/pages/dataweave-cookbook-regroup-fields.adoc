...
:page-aliases: 4.2@mule-runtime::dataweave-cookbook-regroup-fields.adoc
...
[source,dataweave,linenums]
----
include::4.3@partial$cookbook-dw/regroup-fields-ex2/transform.dwl[]
----

.Input JSON Payload:
[source,json,linenums]
----
include::4.3@partial$cookbook-dw/regroup-fields-ex2/inputs/payload.json[]
----

.Output JSON:
[source,json,linenums]
----
include::4.3@partial$cookbook-dw/regroup-fields-ex2/out.json[]
----
