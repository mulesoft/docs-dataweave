...
This example unzips an array of arrays where each input subarray contains more than two elements. It shows that `unzip` can produce more than two output subarrays when there are additional values at each index.
