...
This example unzips an array of arrays where each input sub-array contains more than two elements. It shows that `unzip` can produce more than two output sub-arrays when there are additional values at each index.
