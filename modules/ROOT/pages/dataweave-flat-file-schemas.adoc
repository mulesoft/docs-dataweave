...
:page-aliases: 4.3@mule-runtime::dataweave-flat-file-schemas.adoc
...
image::dataweave-flat-file-schemas-22788.png["A flat file schema with multiple elements and segments"]
...
image::dataweave-flat-file-schemas-680c6.png["A flat file schema with elements and segments"]
