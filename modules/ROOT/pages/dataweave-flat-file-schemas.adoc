...
. Drag an xref:3.9@mule-runtime::3.9@mule-runtime::http-connector.adoc[HTTP Connector] from the palette to your empty canvas, then a *Transform Message Component*.
+
