...
:page-aliases: 4.2@mule-runtime::dataweave-flat-file-schemas.adoc
...
xref:dataweave-formats.adoc#format_flat_file[DataWeave Output Formats and Writer Properties]
