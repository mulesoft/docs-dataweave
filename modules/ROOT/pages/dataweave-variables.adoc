...
:page-aliases: 4.3@mule-runtime::dataweave-variables.adoc
...
[NOTE]
--
xref:3.9@mule-runtime::dataweave-language-introduction#_variables[DataWeave version 1 variables] are described in the Mule 3.9 documentation.
--
