...
:page-aliases: 3.8@mule-runtime::dataweave-xml-reference.adoc
...
If you xref:3.8@mule-runtime::using-maven-in-mule-esb.adoc[use Maven] on your project, you must also include the following dependencies on your `pom.xml` Maven file:
