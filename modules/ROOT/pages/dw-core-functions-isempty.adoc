...
[[isempty4]]
== isEmpty&#40;value: Binary&#41;: Boolean

Returns `true` if the input binary is empty, `false` if not.
...
| `value` | Binary | The input binary value.
|===

=== Example

This example indicates whether the input binary are empty.
