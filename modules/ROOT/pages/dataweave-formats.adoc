...
image::dataweave-formats-580be.png["A reader configuration screen showing the different properties to be set"]
...
+
image::dataweave-formats-4a556.png["A metadata type selection screen showing options to define CSV and XML data types"]
...
+
image::dataweave-formats-excel-metadata.png["A Select metadata type screen with an option to select Type and a table listing fields like name, address, and age."]
...
image::dataweave-formats-6e5e4.png["A reader configuration screen with options for handling null values and optimizing for speed."]
...
+
image::dataweave-formats-27b3c.png["A metadata selection screen with various data type configurations."]
