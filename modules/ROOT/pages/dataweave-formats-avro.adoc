...
|`schemaUrl` (Required) |`String`|`null`|The URL for the Avro schema. Valid URI schemes are `classpath://`, `file://`, or `http://`.
|===
...
DataWeave supports the following Avro types as the top-level element in the schema.
