...
:page-aliases: 4.3@mule-runtime::dw-core-functions-now.adoc
...
https://docs.mulesoft.com/mule-runtime/4.3/dataweave-types#dw_type_dates[Date and Time (dw::Core Types)].
