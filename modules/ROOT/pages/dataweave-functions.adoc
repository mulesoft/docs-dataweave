...
:page-aliases: 4.3@mule-runtime::dataweave-functions.adoc
...
You can find more details about the DataWeave type system in https://docs.mulesoft.com/dataweave/2.3/dataweave-type-system.
