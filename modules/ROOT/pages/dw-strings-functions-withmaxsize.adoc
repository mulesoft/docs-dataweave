...
Checks that the string length isn't larger than the specified `maxLength`. If the string is longer, the function returns a substring that starts at the beginning of the string and is `maxLength` characters long.
