...
:page-aliases: 4.3@mule-runtime::dataweave-quickstart.adoc

In this guide, you run DataWeave version 2 scripts on sample data, without relying
...
contents of a xref:4.3@mule-runtime::about-mule-message.adoc#_message_payload[Mule message]. It enables
...
xref:4.3@mule-runtime::set-payload-transformer-reference.adoc[Set Payload]) are not covered here
...
Studio UI, see xref:4.3@mule-runtime::mule-app-tutorial.adoc[Mule App Development Tutorial].
...
xref:4.3@mule-runtime::mule-components.adoc[Mule Components].
+
...
Message:
+
** xref:4.3@mule-runtime::set-payload-transformer-reference.adoc[Set Payload] to provide
content for the payload of a Mule event.
** xref:4.3@mule-runtime::variable-transformer-reference.adoc[Set Variable] to create content in
a Mule event xref:4.3@mule-runtime::about-mule-variables.adoc[variable].
** xref:4.3@mule-runtime::scheduler-concept.adoc[Scheduler] to trigger the regular generation of Mule events.
** xref:4.3@mule-runtime::logger-component-reference.adoc[Logger] to view output and issues logged
