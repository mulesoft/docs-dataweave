...
:page-aliases: 4.2@mule-runtime::dataweave-quickstart.adoc
...
xref:dataweave-formats.adoc[DataWeave Output Formats and Writer Properties] when you are ready.
+
. Proceed to <<step_3>>
...
function, xref:dataweave-formats.adoc[DataWeave Output Formats and Writer Properties], and
...
contents of a xref:4.2@mule-runtime::mule-runtime::about-mule-message#_message_payload[Mule message]. It enables
...
xref:4.2@mule-runtime::set-payload-transformer-reference.adoc[Set Payload]) are not covered here
...
Studio UI, see xref:4.2@mule-runtime::mule-app-tutorial.adoc[Mule App Development Tutorial].
...
Message:
+
** xref:4.2@mule-runtime::set-payload-transformer-reference.adoc[Set Payload] to provide
content for the payload of a Mule event.
** xref:4.2@mule-runtime::variable-transformer-reference.adoc[Set Variable] to create content in
a Mule event xref:mule-runtime::about-mule-variables.adoc[variable].
** xref:4.2@mule-runtime::scheduler-concept.adoc[Scheduler] to trigger the regular generation of Mule events.
** xref:4.2@mule-runtime::logger-component-reference.adoc[Logger] to view output and issues logged
