...
This example uses the `pluck` function to iterate over the key-value pairs in the source and outputs the values of those pairs into an array of `Test` objects.
