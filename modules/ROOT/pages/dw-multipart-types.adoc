...
https://docs.mulesoft.com/dataweave/2.3/dw-multipart-functions-form[documentation].
...
https://docs.mulesoft.com/dataweave/2.3/dw-multipart-functions-field[documentation].
