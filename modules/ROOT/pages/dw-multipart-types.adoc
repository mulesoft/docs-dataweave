...
:page-aliases: 4.2@mule-runtime::dw-multipart-types.adoc
...
https://docs.mulesoft.com/mule-runtime/4.2/dw-multipart-functions-form[documentation].
...
https://docs.mulesoft.com/mule-runtime/4.2/dw-multipart-functions-field[documentation].
