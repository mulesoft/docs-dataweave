...
:page-aliases: 4.3@mule-runtime::dw-core-functions-readurl.adoc
...
| `readerProperties` | Optional: Sets reader configuration properties. For other formats and reader configuration properties, see xref:dataweave-formats.adoc[Supported Data Formats].
|===
