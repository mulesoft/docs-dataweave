...
:page-aliases: 4.2@mule-runtime::dw-core-functions-readurl.adoc
...
| `readerProperties` | Optional: Sets reader configuration properties. For other formats and reader configuration properties, see https://docs.mulesoft.com/mule-runtime/4.2/dataweave-formats[DataWeave Output Formats and Writer Properties].
|===
